...
This repo uses a spike-based workflow. See [`docs/how-to-spike.md`](docs/how-to-spike.md) for the full process.

- **`TODO.md`** — active work and backlog
- **`docs/`** — process docs, decision records, spike docs, scratch, archive
